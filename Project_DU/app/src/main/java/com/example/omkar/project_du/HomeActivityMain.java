...
public class HomeActivityMain extends AppCompatActivity
    ...
    //Instances
    ImageButton DucollegeIcon, Cutoff, Ug_Admission;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (isFirstRun) {
            ...
            //Audio For Blind
            AudioForBlind = MediaPlayer.create(HomeActivityMain.this, R.raw.areyouablindperson);
            // If not responded correctly
            SpeakAgain = MediaPlayer.create(HomeActivityMain.this, R.raw.pleasespeakyesorno);
            ...
            handler2.postDelayed(new Runnable() {
                ...
                public void run() {
                    ...
                    // If Blind, Another Activity Starts
                        ...
                        dialog.dismiss();
                        Intent BlindHansrajPage = new Intent(HomeActivityMain.this, HansrajPageBlind.class);
...
*/
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_camera) {
            ...
            Intent DU_PRospectus = new Intent(HomeActivityMain.this, DU_Prospectus.class);
    ...
    public void onClick(View v) {
        int id = v.getId();
        if(id==R.id.ducollegeicon){
            Intent DucollegesPage = new Intent(HomeActivityMain.this,DUCollegesAcitivity.class);
            startActivity(DucollegesPage);
        }

        if(id==R.id.cutoff){
            Intent Cutoff_list = new Intent(HomeActivityMain.this,Cutoff_list.class);
            startActivity(Cutoff_list);
        }

        if(id==R.id.ug_admission){
            Intent Ug_AdmissionIN = new Intent(HomeActivityMain.this,Ug_Admissions.class);
